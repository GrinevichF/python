...
for i in my_list:
    if i > 0 and math.sqrt(i) % 1 == 0:
        my_new_list.append(int(math.sqrt(i)))
print(my_new_list)
...
cur_date = '31.12.2013'
date_splited = cur_date.split('.')
date_dict = {'01': 'первое','02': 'второе','03': 'третье','04': 'четвертое',
        ...
        '18': 'восемьнадцатое','19': 'девятьнадцатое','20': 'двадцатое',			
...
cur_date_txt = date_dict[date_splited[0]]+' '+month_dict[date_splited[1]]+ ' '\
                + date_splited[2] + ' года'
print(cur_date_txt)
